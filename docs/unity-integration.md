...
1. Unity Package Manager 选择 **Install package from git URL**，推荐使用固定版本地址 `https://github.com/blaze-tc/RadarControl.git?path=/UnityPackage/com.blaze.radar#v1.1.1`；也可以选择 **Add package from disk** 并打开 `UnityPackage/com.blaze.radar/package.json`。
